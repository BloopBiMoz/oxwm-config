...
local bar_font = "Lilex Nerd Font Bold:style=Bold:size=10"
...
oxwm.rule.add({ instance = " xfce4-appfinder ", tiling = false, fullscreen = false })                             
oxwm.rule.add({ class = " xfce-terminal ", tag = 1, focus = true })                             
...
-- Audio for PipeWire
--oxwm.key.bind({}, "XF86AudioRaiseVolume", oxwm.spawn({ "wpctl", "set-volume", "@DEFAULT_SINK@", "5%+" }))
...
oxwm.autostart("xfce4-notifyd")
oxwm.autostart("xfce4-power-manager")
oxwm.autostart("eos-welcome")
